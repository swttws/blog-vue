...
export default {
  ...
  methods: {
    ...
    before() {
      if(this.articleId){
        this.$router.push({ path: "/user_manager/article?id=" + this.userId +'&articleId='+this.articleId });
      }else{
        this.$router.push({ path: "/user_manager/article?id=" + this.userId });
      }
