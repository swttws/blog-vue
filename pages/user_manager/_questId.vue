      ...
      <el-main>
        ...
        <div v-else>
          ...
          >
            ...
            <div style="margin-top: -5%;margin-left: 80%;" v-if="answer.answerAdopt == 2&&flag==true">
                <el-button type="success" @click="acceptAnswer(answer.id)" plain size="mini">采纳回答</el-button>
            </div>
...
export default {
  ...
  methods: {
    ...
    getQuestAndAnswer() {
      question.getQuestById(this.questId,this.pagination,this.userId).then((resp) => {
        ...
        for(var i=0;i<this.answerList.length;i++){
          if(this.answerList[i].answerAdopt==1){
            this.flag=false
          }
        }
    ...
    acceptAnswer(answerId){
      answer.updateAnswerAdopt(answerId).then(resp=>{
        this.getQuestAndAnswer()
      })
    },
  },
