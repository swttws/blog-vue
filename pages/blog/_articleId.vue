<template>
  <div>
    ...
    <a href="/" style="font-size: 1.3pc;color: blue;position: absolute;top: 13%;margin-left: 3%;">返回首页</a>
...
export default {
  ...
  methods: {
    ...
    initInformation() {
      ...
      article
        ...
        .then((resp) => {
          ...
          console.log("total=" + resp.data.data.total);
          //点赞过，收藏过的样式变红
    ...
    //增加阅读量
    addReadNumber(){
      article.addReadNum(this.articleId).then(resp=>{
        console.log("阅读量加一")
      })
    }
  },
